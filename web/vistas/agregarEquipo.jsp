...
<html>
    ...
    <body class="estilosKefer">
        ...
        <div class="container">
            <div class="col-lg-6">
                <h1>Agregar Equipo al Inventario</h1>
                <form action="Controlador">                
                Equipo: <br>
                <input class="form-control" type="text" name="txtEqui"><br>
                Marca: <br>
                <input class="form-control" type="text" name="txtMar"><br>
                Estado: <br>
                <input class="form-control" type="text" name="txtEst"><br>               
                <input class="btn btn-primary" type="submit" name="accion" value="Agregar Equipo">
